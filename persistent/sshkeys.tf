...
resource "hcloud_ssh_key" "danilo_x2000" {
  name = "danilo_x2000"
  public_key = "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAINLz2Powl1YbwULqKC5RQoPZo4sbfUAYJKym0K99XSzO danilo@x2000"
}
...
output "ssh_key_id3" {
  value = hcloud_ssh_key.danilo_x2000.id
}
